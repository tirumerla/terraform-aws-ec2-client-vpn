...
| <a name="input_existing_security_group_ids"></a> [existing\_security\_group\_ids](#input\_existing\_security\_group\_ids) | List of security group ids that needs to be attached to the client vpn endpoint. Set this if `var.use_existing_security_group_ids` is set to true. | `list(string)` | `[]` | no |
...
| <a name="input_server_certificate_arn"></a> [server\_certificate\_arn](#input\_server\_certificate\_arn) | ARN of the existing ACM server certificate. | `string` | `null` | no |
...
| <a name="input_use_existing_security_group_ids"></a> [use\_existing\_security\_group\_ids](#input\_use\_existing\_security\_group\_ids) | Whether to use existing security group ids with client vpn endpoint. If this is true, set `var.existing_security_group_ids` | `bool` | `false` | no |
